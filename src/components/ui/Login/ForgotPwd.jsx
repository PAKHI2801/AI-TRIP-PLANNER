...
const ForgotPwd = () => {
  ...
  return (
    <div className="bg-[url('/sea.jpg')] min-h-screen flex items-center justify-center bg-cover bg-center px-4 py-8"> {/* Added py-8 for vertical padding */}
      <div className="bg-white/30 backdrop-blur-xl shadow-2xl rounded-2xl p-6 sm:p-10 w-full max-w-md border border-white/40"> {/* Adjusted padding for smaller screens */}
        <div className="flex flex-col items-center">
          <MailCheck className="h-16 w-16 text-black mb-4" />
          <h2 className="text-3xl font-bold text-black drop-shadow mb-2">
            Forgot Password?
          </h2>
          <p className="text-black/90 text-center mb-6">
            Enter your registered email ID and we'll send you a verification
            link.
          </p>
        </div>
